...
Pe ParsePeImage(LPCSTR imageName) {
	...
	PIMAGE_LOAD_CONFIG_DIRECTORY loadConfigDir = (PIMAGE_LOAD_CONFIG_DIRECTORY)(peBase + OptionalHeader.DataDirectory[IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG].VirtualAddress);
	PIMAGE_CFG_ENTRY GuardCffTable = (PIMAGE_CFG_ENTRY)loadConfigDir->GuardCFFunctionTable;
